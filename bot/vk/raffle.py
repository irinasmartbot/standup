...
USED_RAFFLE_TEXT = (
    "Ты уже использовал(а) возможность получить <b>бесплатный билет</b> по розыгрышу 😊"
)
ACTIVE_BOOKING_TEXT = (
    "У тебя уже есть <b>активная бронь</b> по розыгрышу. "
...
SCREEN_OK_TEXT = (
    "<b>Супер</b>, проверю твой скрин и вернусь обратно 👌\n\n"
    "Менеджер проверит скрин <b>в течение часа</b>, ожидайте."
)
NOT_IMAGE_TEXT = "Нужен именно <b>скрин-картинка</b> 📷 Пришли фото или изображение ещё раз 👇"
ALBUM_TEXT_POST = "Принимаем только <b>1 скрин поста</b> — пришли одно фото 📷"
ALBUM_TEXT_REVIEW = "Принимаем только <b>1 скрин отзыва</b> — пришли одно фото 📷"
SCREEN_ACCEPTED_TEXT = (
    "<b>Класс, скрин принят.</b> Теперь проверим подписку на сообщество 👌"
)

SUB_OK_DATES_TEXT = (
    "<b>Отлично</b>, подписка на сообщество есть 🙌\n\n"
    "Теперь выбирай дату, на которую хочешь получить <b>бесплатный билет</b> 😉"
)
SUB_MISSING_TEXT = (
    "Не видим вашей подписки. <b>Подпишись на сообщество</b> и нажми кнопку ниже 👇"
)


def start_text(community_link: str) -> str:
    # Временно без пункта про подписку (модерация VK mini app).
    # В боевом режиме вернуть:
    # 1. Быть подписанным на наше сообщество…
    # 2. Выложить пост / отзыв…
    _ = community_link
    return (
        "<b>Привет-привет</b> 🥳 😊\n\n"
        "<b>Что нужно сделать, чтобы получить билетик?</b>\n\n"
        "Выложить в соцсети <b>пост со ссылкой на наш сайт</b> или <b>оставить отзыв</b> 😊\n\n"
...
POST_TEXT = (
    ...
    "Если в Instagram* — <b>обязательно</b> сделай ссылку в сторис кликабельной 😉\n\n"
    "Затем нажимай кнопку ниже, отправляй скрин поста <b>одним фото</b> "
    "и выбирай любую дату ☺️ "
    "(после выбора даты билеты <b>переносу не подлежат</b>)\n\n"
    "🎫 За 1 пост полагается <b>1 билет</b>\n\n"
    "____________________\n"
    "<i>*запрещено в РФ</i>"
)

REVIEW_TEXT = (
    f"<b>Оставляем отзыв</b> по ссылке:\n{AFISHA_REVIEW_URL}\n\n"
    "И <b>обязательно</b> нажать на вот эти кнопочки как на фото 😻\n\n"
    "Затем нажимайте кнопку ниже, отправляйте скрин отзыва <b>одним фото</b> "
    "и выбирайте любую дату 😻\n\n"
    "🎟️ После выбора даты билеты <b>переносу не подлежат</b>\n"
    "🎫 За 1 отзыв полагается <b>1 билет</b>"
)

POST_REJECT_TEXT = (
    "К сожалению скрин <b>не прошел модерацию</b>. 😔\n\n"
    "Необходимо выложить в соцсети пост со ссылкой на наш сайт:\n\n"
    f"<b>{SITE_URL.replace('https://', '').replace('http://', '')}</b> 😊\n\n"
    "Если в инстаграм* — <b>обязательно</b> сделать ссылку в сторис кликабельной 👌\n\n"
...
RAFFLE_RULES_TEXT = (
    ...
    "❗ <b>ВНИМАНИЕ</b>, ваш билет на <b>одного человека</b>, если вы хотите пойти с друзьями, они могут "
    ...
    "4. Если поменяются планы и Вы не сможете присутствовать, пожалуйста, "
    "<b>ОБЯЗАТЕЛЬНО ПРЕДУПРЕДИТЕ</b> 😊\n\n"
    "5. После выбора даты билеты <b>переносу не подлежат</b>."
)
...
async def continue_after_subscribe_check(vk_id: int, *, manual_attempts: int = 0) -> bool:
    ...
    if subscribed:
        ...
        await send_vk_text(
            vk_id,
            "<b>Подписка есть</b>, но список дат не отправился. Нажми кнопку ниже 👇",
