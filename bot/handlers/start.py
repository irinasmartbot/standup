...
WELCOME_TEXT = (
    ...
    "<b>Здесь можно забронировать места на бесплатные шоу или купить билеты на "
    "StandUp BEST и Хитлото.</b>"
)
...
<p> </p>
<h3>Здесь можно забронировать места на бесплатные шоу или купить билеты на StandUp BEST и Хитлото.</h3>
"""
