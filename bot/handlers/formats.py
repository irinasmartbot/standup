...
BUY_TICKET_TEXT = (
    "<b>Здесь можно посмотреть афишу по платным форматам и купить билет.</b>\n\n"
    "Выбирай формат шоу\n\n"
    "<b>StandUp BEST</b>\n"
...
<h2>Здесь можно посмотреть афишу по платным форматам и купить билет.</h2>
<p>Выбирай формат шоу</p>
<h3>StandUp BEST</h3>
