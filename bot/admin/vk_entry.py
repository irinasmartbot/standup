...
FLOWS: dict[str, dict[str, Any]] = {
    "booking": {
        ...
        "lead": "Разрешите сообщения от сообщества — и мы отправим вам кнопку бронирования в личку VK.",
    ...
    "raffle": {
        ...
        "lead": "Разрешите сообщения от сообщества — пришлём инструкцию и кнопки розыгрыша в личку.",
    ...
    "offline_gift": {
        "path": "/vk/offline-gift",
        "title": "Подарок",
        "headline": "Офлайн-розыгрыш подарка",
        "lead": "Разрешите сообщения — добавим вас в список участников (нужна подписка на сообщество).",
        "cta": "Вступить в розыгрыш",
        "cmd": "offline_gift",
        "button": "Участвовать в розыгрыше подарка",
        "message": "Нажмите кнопку ниже, чтобы выбрать шоу и попасть в список на подарок 👇",
    },
}

# Антиспам: один успешный entry на vk_id+flow раз в N секунд.
...
(function () {{
  ...
  function enableCta(userId) {{
    vkId = userId;
    cta.disabled = false;
    setStatus("Сообщения разрешены. Нажмите кнопку ниже.", true);
  }}
